...
const IMG = {
  ...
  product1:
    "https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04?w=1000&q=80",
  journal1:
...
export const fallbackSections: HomeSection[] = [
  ...
  },
  {
    ...
    bodyEn:
      "Three core services plus a physical product — all designed for enterprise impact.",
...
export const fallbackPosts: Post[] = [
  {
    ...
    excerptEn:
      "Three patterns I see in every failed CRM rollout — and how to avoid them.",
  ...
  },
  {
    ...
    excerptEn:
      "Compliance, scaling, and integration patterns for WhatsApp at scale.",
...
export const fallbackGallery: GalleryItem[] = [
  {
    ...
    slug: "eksb-platform",
    excerptEn:
      "Enterprise CRM and operations platform built for measurable impact across teams.",
  ...
  },
  {
    ...
    excerptEn:
      "Automated WhatsApp engagement that qualifies leads and supports customers around the clock.",
    excerptAr:
      "تفاعل واتساب مؤتمت يؤهل العملاء المحتملين ويدعم العملاء على مدار الساعة.",
    bodyEn:
  ...
  },
  {
    ...
    excerptEn:
      "Hospitality technology that streamlines booking, guest experience, and operations.",
