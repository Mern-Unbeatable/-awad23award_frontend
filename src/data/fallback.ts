...
export const fallbackServices: Service[] = [
  ...
  },
  {
    ...
    subtitleEn: 'Conversational',
    subtitleAr: 'محادثات',
    excerptEn:
      'Build WhatsApp Business API flows for support, sales, and notifications at enterprise scale.',
    excerptAr:
      'بناء تدفقات WhatsApp Business API للدعم والمبيعات والإشعارات على نطاق مؤسسي.',
    bodyEn:
      '<p>Automate customer conversations without losing the human touch. From chatbots to agent handoff, I deliver compliant WhatsApp integrations for KSA and international markets.</p>',
    bodyAr:
      '<p>أتمتة محادثات العملاء دون فقدان اللمسة البشرية. من روبوتات الدردشة إلى تحويل الوكيل، أقدم تكاملات واتساب متوافقة للسعودية والأسواق العالمية.</p>',
    featuresEn: [
    ...
    featuresAr: ['إعداد WhatsApp Business API', 'تصميم روبوتات وتدفقات', 'مزامنة CRM وسجلات', 'دعم متعدد اللغات'],
