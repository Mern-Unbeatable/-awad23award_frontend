...
export function SiteProvider({ children }: { children: ReactNode }) {
  ...
  const refresh = useCallback(async () => {
    ...
    setSettings({
      ...
      contactPhone: s.contactPhone || fallbackSettings.contactPhone,
      socialLinkedin: s.socialLinkedin || fallbackSettings.socialLinkedin,
      socialInstagram: s.socialInstagram || fallbackSettings.socialInstagram,
