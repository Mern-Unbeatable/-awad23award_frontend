...
export function Hero() {
  ...
  const statsConfig = [
    ...
    },
    {
      ...
      formatCommas: true,
      baseDelay: 0.4,
      label: t("Hours Solving Business Problems", "ساعة في حل مشكلات الأعمال"),
    },
    {
      end: 2,
      suffix: "+",
      formatCommas: false,
      baseDelay: 1.4,
      label: t("Technology Ventures Founded", "مشاريع تقنية تم تأسيسها"),
    },
  ];
  ...
  return (
    <section
      id="top"
      className="relative bg-[#1A2828] overflow-hidden text-forest-foreground"
    >
      <Nav />
      
      {/* background colors with image from figma */}
      <div className="absolute hidden md:block right-0 top-0">
        <img src="/righcorner.png" className="" alt="" />
      </div>
      <div className="absolute hidden md:block right-0 top-0">
        <img src="/rightcorner.png" className="" alt="" />
      </div>
      <div className="absolute hidden md:block left-3 top-0">
        <img src="/middle.png" className="" alt="" />
      </div>
      ...
      <div className="container mx-auto px-5 sm:px-6 relative flex flex-col lg:grid lg:grid-cols-12 gap-6 lg:gap-6 pt-24 sm:pt-32 pb-12 lg:pt-36 lg:pb-0">
        ...
        <div className="relative z-20 lg:col-span-6 flex flex-col items-start text-start">
          ...
          {/* Main Headline */}
          <h1
            className={`mt-4 text-[31px] sm:text-[44px] lg:text-[56px] leading-[1.14] font-semibold text-white tracking-tight max-w-full${isRtl ? " lg:max-w-105" : ""}`}
          >
            {isRtl
              ? t(
                        ...
                        >
                          ...
                          {wordIdx < words.length - 1 && (
                            <span
                              className="inline-block animate-hero-title-wave"
                              style={{
                                animationDelay: `${globalCharIdx++ * 0.048}s`,
                              }}
                            >
                              &nbsp;
                            </span>
          ...
          >
            <div className="relative inline-block mx-auto">
              <div
                className="absolute inset-0 bg-[#35BFFB]/20 blur-2xl rounded-full transform scale-90"
                aria-hidden
              />
              <img
                src="/award1.png"
          ...
          <dl className="mt-8 sm:mt-14 flex flex-wrap gap-6 sm:gap-8 pb-6 lg:pb-14 w-full border-t border-white/10 pt-6 lg:border-none lg:pt-0">
            {statsConfig.map((s, idx) => (
              <div
                key={idx}
                className="flex flex-col shrink-0 group cursor-default"
              >
                <dt className="font-display text-[1.8rem] sm:text-[2.2rem] lg:text-[2.2rem] leading-none font-bold text-white transition-colors duration-300">
                  <AnimatedCounter
                    ...
                    suffix={s.suffix}
                    formatCommas={s.formatCommas}
                    baseDelay={s.baseDelay}
                    duration={2200}
                    isRtl={isRtl}
                  />
                </dt>
                <dd className="mt-2 text-[11px] sm:text-[12.5px] text-white/75 font-normal leading-snug whitespace-nowrap">
                  {s.label}
                </dd>
              </div>
            ))}
          ...
          <div className="relative rounded-2xl bg-white/7 backdrop-blur-md border border-white/12 p-5 shadow-[0_8px_40px_rgba(0,0,0,0.3)] overflow-hidden">
            ...
            <div className="relative flex flex-col gap-0">
              ...
              <div className="flex items-start gap-3">
                <div className="flex flex-col items-center">
                  ...
                  <div className="relative flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#35BFFB]/20 border border-[#35BFFB]/40 shadow-[0_0_12px_rgba(53,191,251,0.3)]">
                    ...
                    <span
                      className="absolute inset-0 rounded-full animate-ping bg-[#35BFFB]/20"
                      style={{ animationDuration: "2.5s" }}
                    />
                  </div>
                  {/* Animated connector */}
                  <div
                    className="relative w-px flex-1 my-1 overflow-hidden"
                    style={{ height: "40px" }}
                  >
                    <div className="absolute inset-0 bg-linear-to-b from-[#35BFFB]/50 to-emerald-400/50" />
                    <div
                      className="absolute top-0 left-0 w-full animate-journey-beam"
                      style={{
                        height: "40%",
                        background:
                ...
                <div className="pt-1 pb-5">
                  <p className="text-[12px] font-bold text-[#35BFFB] tracking-wide uppercase">
                    {t("Malaysia", "ماليزيا")}
                  </p>
                  <p className="text-[12.5px] text-white/80 mt-0.5">
                    {t("Studied & built foundations", "دراسة وبناء الأسس")}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="pt-1">
                  <p className="text-[12px] font-bold text-emerald-400 tracking-wide uppercase">
                    {t("Saudi Arabia", "السعودية")}
                  </p>
                  <p className="text-[12.5px] text-white/80 mt-0.5">
                    {t("Built real-world solutions", "بنى حلولاً واقعية")}
                  </p>
                </div>
              </div>
            </div>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, rgba(6,71,56,0.5) 0%, #ffffff 100%)",
        }}
        aria-hidden
      />
