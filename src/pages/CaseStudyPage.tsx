...
export function CaseStudyPage() {
  ...
  // Hero
  const heroImage        = item?.heroImageUrl || 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1400&q=80';
  const client           = item?.client       || 'Real Estate Development Fund (REDF)';
  const role             = item?.role         || 'CRM Consultant & Technical Lead';
  const duration         = item?.duration     || '6-Month Engagement • CRM 2.0 Delivery';
  ...
  const challengeImage   = item?.challengeImageUrl        || 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1000&q=80';
  ...
  const solutionArchImg  = item?.solutionArchImageUrl     || 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1000&q=80';
  ...
  const recognitionImage = item?.recognitionImageUrl      || 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80';
